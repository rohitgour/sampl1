           ...
           try
            {
                ...
                UpdateCandidateDto candidate1=new UpdateCandidateDto();
                for(FileItem item:multiparts)
                {
                    ...
                    else
                    {
                        ...
                        if(!fileName.isEmpty())
                        {
                            candidate1.setFlag(true);
                            System.out.println("Image Name ="+fileName); 
                        }  
                        else
                         {
                              candidate1.setFlag(false);                          
                              System.out.println("Blank Name ="+fileName);
                         }
                    }
                }
               //String img=CandidateDao.getImage(userid);
                //System.out.println("img = "+img);
               //System.out.println("img = "+img.isEmpty());
               // System.out.println("objValues = "+objValues);
              UpdateCandidateDto candidate= new UpdateCandidateDto(objValues.get(0),objValues.get(1),objValues.get(2),fileContent,candidate1.isFlag()); 
              boolean result=CandidateDao.updateCandidate(candidate);
              //System.out.println("result of update qry = "+result);
              if(result==true)
               {
